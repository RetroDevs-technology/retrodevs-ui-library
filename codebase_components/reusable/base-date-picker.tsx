...
import { useIsMobile } from "@/lib/hooks/use-breakpoints"
...
import { ShadMobileDatePicker } from "@/components/ui/shad-mobile-date-picker"
...
const normalizeDate = (date: Date | undefined): Date | undefined => {
  ...
  // Only normalize to midnight if we're not dealing with time selection
  // This preserves the actual selected time without timezone conversion
  return date
}
