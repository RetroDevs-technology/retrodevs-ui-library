...
interface ChartTooltipContentProps {
  ...
  label?: string | number
  labelFormatter?: (value: string | number | undefined, payload: Array<unknown>) => React.ReactNode
  formatter?: (
    value: number | string,
    name: string,
    item: unknown,
...
export function ChartTooltipContent({
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    if (labelFormatter) {
      const labelValue = typeof value === "string" || typeof value === "number" ? value : undefined
      return (
